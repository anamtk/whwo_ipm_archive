...
mod <- readRDS("/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/adult_occupancy_2_JAGS.RDS")
# 
...
data <- readRDS("/scratch/user/whwo_ipm/parameter_models/adult_occupancy/inputs/adult_occupancy_data.RDS")
...
# INits -------------------------------------------------------------------
# 
# #inits <- readRDS("/scratch/user/whwo_ipm/parameter_models/adult_occupancy/inputs/adult_occupancy_inits.RDS")
...
mod <- jagsUI::jags(data = data_list,
                    inits = inits,
                    #inits = NULL,
                    model.file = '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/inputs/adult_dyn_occupancy_remoteonly_notransect.R',
...
saveRDS(mod, 
        file ="/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/adult_occupancy_3_JAGS.RDS")
...
mcmcplot(mod$samples, 
         dir = '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/mcmcplots/third')

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/model_Rhat3.RDS")
