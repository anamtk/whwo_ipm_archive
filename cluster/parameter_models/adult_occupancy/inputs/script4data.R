...
mod <- readRDS("/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/adult_occupancy_3_JAGS.RDS")
# 
...
mod <- jagsUI::jags(data = data_list,
                    inits = inits,
                    #inits = NULL,
                    model.file = '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/inputs/adult_dyn_occupancy_phionly_transect.R',
...
saveRDS(mod, 
        file ="/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/adult_occupancy_4_JAGS.RDS")
...
mcmcplot(mod$samples, 
         dir = '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/mcmcplots/fourth')

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/model_Rhat4.RDS")
