...
mod <- readRDS("/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/adult_occupancy_inits_JAGS.RDS")
...
mod <- jagsUI::jags(data = data_list,
                    inits = inits,
                    #inits = NULL,
                    model.file = '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/inputs/adult_dyn_occupancy_phionly.R',
...
saveRDS(mod, 
        file ="/scratch/user/whwo_ipm/parameter_models/adult_occupancy/outputs/adult_occupancy_2_JAGS.RDS")
