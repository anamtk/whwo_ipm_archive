...
th_mod <- '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/adult_TH.R'
...
saveRDS(LL2,
        '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_TH_results_empaid.R')
...
saveRDS(output, 
        "/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_TH_parameter_samples_empaid.RDS")
