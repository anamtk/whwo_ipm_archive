...
t_mod <- '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/adult_T.R'
...
saveRDS(LL2,
        '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_T_results_empaid.R')
...
saveRDS(output, 
        "/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_T_parameter_samples_empaid.RDS")
