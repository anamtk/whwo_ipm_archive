...
saveRDS(LL2,
        '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_HC_results_empaid.R')
...
saveRDS(output, 
        "/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_HC_parameter_samples_empaid.RDS")
