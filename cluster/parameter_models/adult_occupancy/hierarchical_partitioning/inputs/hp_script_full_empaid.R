...
data <- readRDS("/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/reduced_adult_data_list_empaid.RDS")
...
saveRDS(LL2,
        '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_full_results_empaid.R')
...
saveRDS(output, 
        "/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_THC_parameter_samples_empaid.RDS")
