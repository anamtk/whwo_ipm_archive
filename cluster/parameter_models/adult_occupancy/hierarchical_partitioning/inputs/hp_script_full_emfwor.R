...
data <- readRDS("/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/reduced_adult_data_list_emfwor.RDS")
...
full_mod <- '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/adult_full.R'
...
saveRDS(LL2,
        '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_full_results_emfwor.R')
...
saveRDS(output, 
        "/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_THC_parameter_samples_emfwor.RDS")
