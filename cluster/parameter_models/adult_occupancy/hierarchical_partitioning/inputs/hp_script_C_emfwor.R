...
model_file <- '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/adult_C.R'
...
saveRDS(LL2,
        '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_C_results_emfwor.R')
...
saveRDS(output, 
        "/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_C_parameter_samples_emfwor.RDS")
