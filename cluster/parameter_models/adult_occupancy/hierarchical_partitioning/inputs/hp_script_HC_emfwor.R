...
hc_mod <- '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/adult_HC.R'
...
saveRDS(LL2,
        '/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_HC_results_emfwor.R')
...
saveRDS(output, 
        "/scratch/user/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_HC_parameter_samples_emfwor.RDS")
