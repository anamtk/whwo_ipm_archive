...
adult <- readRDS(here('monsoon',
                      ...
                      'outputs',
                      'adult_THC_parameter_samples_empaid.RDS'))
...
#for now: just simulating some fake data

#Adult initials
#matrix where columns are forests
# b0.array <- adult$b0
# 
# b.array <- adult$b
# 
# #number of covariates
# n.ad0.cov <- ncol(b.array)
...
saveRDS(data, here("data",
                   "04_ipm_data_inputs",
                   "posterior_data_list_empaid.RDS"))
