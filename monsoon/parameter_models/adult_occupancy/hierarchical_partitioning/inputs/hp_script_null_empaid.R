...
data <- readRDS("/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/reduced_adult_data_list_empaid.RDS")
...
saveRDS(LL2,
        '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_null_results_empaid.R')
...
saveRDS(output, 
        "/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_null_parameter_samples_empaid.RDS")
