...
saveRDS(LL2,
        '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_T_results_emfwor.R')
...
saveRDS(output, 
        "/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_T_parameter_samples_emfwor.RDS")
