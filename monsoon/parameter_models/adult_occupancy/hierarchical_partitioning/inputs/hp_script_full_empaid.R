...
full_mod <- '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/adult_full.R'
...
saveRDS(LL2,
        '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_full_results_empaid.R')
...
saveRDS(output, 
        "/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_THC_parameter_samples_empaid.RDS")
