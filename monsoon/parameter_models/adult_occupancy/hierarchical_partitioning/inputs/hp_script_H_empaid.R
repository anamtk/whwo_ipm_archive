...
model_file <- '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/adult_H.R'
...
saveRDS(LL2,
        '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_H_results_empaid.R')
...
saveRDS(output, 
        "/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_H_parameter_samples_empaid.RDS")
