...
th_mod <- '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/inputs/adult_TH.R'
...
saveRDS(LL2,
        '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_TH_results_emmaor.R')
...
saveRDS(output, 
        "/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/hp/outputs/adult_TH_parameter_samples_emmaor.RDS")
