...
mod <- readRDS("/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/outputs/adult_occupancy_inits_JAGS.RDS")
# 
...
mod <- jagsUI::jags(data = data_list,
                    inits = inits,
                    #inits = NULL,
                    model.file = '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/inputs/adult_dyn_occupancy_remoteonly_notransect.R',
...
saveRDS(mod, 
        file ="/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/outputs/adult_occupancy_2_JAGS.RDS")
...
mcmcplot(mod$samples, 
         dir = '/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/outputs/mcmcplots/second')

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/atm234/whwo_ipm/parameter_models/adult_occupancy/outputs/model_Rhat2.RDS")
